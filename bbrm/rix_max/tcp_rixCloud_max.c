...
//deprecated	struct minmax max_rtt;
	...
	u32     mode:3,		     /* current bbr_mode in state machine */
		...
		tso_segs_goal:1,     /* segments we want in each skb we send */
...
static const int bbr_min_tso_rate = 120000000;
 ...
 */
static const int bbr_high_gain  = BBR_UNIT * 3921 / 1000 + 1;
			 ...
			 u32 acked, u32 bw, int gain)
{
	...
	if (bbr_full_bw_reached(sk))  /* only cut cwnd if we filled the pipe */
		cwnd = max(cwnd + acked, target_cwnd);
